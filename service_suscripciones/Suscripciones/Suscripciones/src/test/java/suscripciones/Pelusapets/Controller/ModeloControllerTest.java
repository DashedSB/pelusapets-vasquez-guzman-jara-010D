...
import org.springframework.test.context.bean.override.mockito.MockitoBean; // Import correcto para Spring Boot 3.4/3.5+
...
class ModeloControllerTest {
    ...
    @MockitoBean // Anotación moderna requerida en Spring Boot 3.5
